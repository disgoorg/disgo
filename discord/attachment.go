...
// [AttachmentKeep] to retain (and optionally edit) an existing Attachment
// [AttachmentCreate] to describe a newly uploaded file
...
// NewAttachmentCreate returns a new AttachmentCreate with the provided ID and no other fields set.
//
// ID must match the n in files[n] of the file this AttachmentCreate describes.
func NewAttachmentCreate(id int) AttachmentCreate {
	return AttachmentCreate{ID: id}
}
