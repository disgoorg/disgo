...
func (i *CreateInteractionResponses) DeferCreate(ephemeral bool, opts ...rest.RequestOpt) error {
...
func (i *CreateInteractionResponses) Create(messageCreate discord.MessageCreate, opts ...rest.RequestOpt) error {
...
func (i *CreateInteractionResponses) GetOriginal(opts ...rest.RequestOpt) (*Message, error) {
...
func (i *CreateInteractionResponses) UpdateOriginal(messageUpdate discord.MessageUpdate, opts ...rest.RequestOpt) (*Message, error) {
...
func (i *CreateInteractionResponses) DeleteOriginal(opts ...rest.RequestOpt) error {
...
func (i *CreateInteractionResponses) CreateFollowup(messageCreate discord.MessageCreate, opts ...rest.RequestOpt) (*Message, error) {
...
func (i *CreateInteractionResponses) UpdateFollowup(messageID discord.Snowflake, messageUpdate discord.MessageUpdate, opts ...rest.RequestOpt) (*Message, error) {
...
func (i *CreateInteractionResponses) DeleteFollowup(messageID discord.Snowflake, opts ...rest.RequestOpt) error {
