...
type ApplicationCommandOptionsInteraction struct {
	*ApplicationCommandInteraction
	ApplicationCommandOptionsInteractionData
}
...
type ApplicationCommandOptionsInteractionData struct {
	SubCommandName      *string
	SubCommandGroupName *string
	Options             ApplicationCommandOptionsMap
}

type ApplicationCommandOptionsMap map[string]ApplicationCommandOption

func (m ApplicationCommandOptionsMap) Get(name string) *ApplicationCommandOption {
...
func (m ApplicationCommandOptionsMap) GetAll() []ApplicationCommandOption {
...
func (m ApplicationCommandOptionsMap) GetByType(optionType discord.ApplicationCommandOptionType) []ApplicationCommandOption {
	return m.FindAll(func(option ApplicationCommandOption) bool {
		return option.Type == optionType
	})
}

func (m ApplicationCommandOptionsMap) Find(optionFindFunc func(option ApplicationCommandOption) bool) *ApplicationCommandOption {
	for _, option := range m {
...
func (m ApplicationCommandOptionsMap) FindAll(optionFindFunc func(option ApplicationCommandOption) bool) []ApplicationCommandOption {
...
func (m ApplicationCommandOptionsMap) FocusedOption() ApplicationCommandOption {
	return *m.Find(func(option ApplicationCommandOption) bool {
