...
// GuildChannel returns the api.GetGuildChannel the GenericGuildInviteEvent happened in(returns nil if the api.GetGuildChannel is uncached or api.Caches is disabled)
func (e GenericGuildInviteEvent) GuildChannel() core.GuildChannel {
	return e.Disgo().Caches().ChannelCache().GetGuildChannel(e.ChannelID)
}

// MessageChannel returns the api.GetMessageChannel the GenericGuildInviteEvent happened in(returns nil if the api.GetMessageChannel is uncached or api.Caches is disabled)
...
func (e GenericGuildInviteEvent) VoiceChannel() core.VoiceChannel {
	return e.Disgo().Caches().VoiceChannelCache().Get(e.ChannelID)
}
...
func (e GenericGuildInviteEvent) StoreChannel() core.StoreChannel {
	return e.Disgo().Caches().StoreChannelCache().Get(e.ChannelID)
}
...
func (e GenericGuildInviteEvent) Category() core.Category {
	return e.Disgo().Caches().CategoryCache().Get(e.ChannelID)
}
