...
// SetActionRow sets the provided ActionRow at the index of core.Component(s)
...
// AddActionRow adds a new ActionRow with the provided core.Component(s) to the Message
