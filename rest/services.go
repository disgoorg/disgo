...
type ApplicationService interface {
	...
	GetGuildCommands(applicationID discord.Snowflake, guildID discord.Snowflake) ([]discord.Command, Error)
	GetGuildCommand(applicationID discord.Snowflake, guildID discord.Snowflake, commandID discord.Snowflake) (*discord.Command, Error)
	CreateGuildCommand(applicationID discord.Snowflake, guildID discord.Snowflake, command discord.CommandCreate) (*discord.Command, Error)
	SetGuildCommands(applicationID discord.Snowflake, guildID discord.Snowflake, commands ...discord.CommandCreate) ([]discord.Command, Error)
	UpdateGuildCommand(applicationID discord.Snowflake, guildID discord.Snowflake, commandID discord.Snowflake, command discord.CommandUpdate) (*discord.Command, Error)
...
type WebhookService interface {
	...
	CreateWebhookMessage(webhookID discord.Snowflake, webhookToken string, messageCreate discord.MessageCreate, wait bool, threadID discord.Snowflake) (*discord.Message, Error)
	CreateWebhookMessageSlack(webhookID discord.Snowflake, webhookToken string, messageCreate discord.MessageCreate, wait bool, threadID discord.Snowflake) (*discord.Message, Error)
	CreateWebhookMessageGitHub(webhookID discord.Snowflake, webhookToken string, messageCreate discord.MessageCreate, wait bool, threadID discord.Snowflake) (*discord.Message, Error)
	UpdateWebhookMessage(webhookID discord.Snowflake, webhookToken string, messageID discord.Snowflake, messageUpdate discord.MessageUpdate) (*discord.Message, Error)
	DeleteWebhookMessage(webhookID discord.Snowflake, webhookToken string, messageID discord.Snowflake) Error
}
