...
func (h *gatewayHandlerGuildScheduledEventUpdate) HandleGatewayEvent(client bot.Client, sequenceNumber int, v any) {
	...
	client.EventManager().DispatchEvent(&events.GuildScheduledEventUpdateEvent{
